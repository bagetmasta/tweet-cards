# Описание проекта Tweet cards

Этот проект был создан с целью возможности подписки на одного из 10 персонажей,
записаных в локальную базу данных с помощью файла JSON.

Каждая карточка с персонажем является автономной и не зависящей от других.

При закрытии вкладки Вы можете не переживать, что "потеряете" подписку, так как
...
![Creating repo from a template step 1](./src/images/readme/template-step-1.png)
